...
这个系列我打算用大白话 + 可运行代码，把 SECS/GEM 从通讯层到 GEM300 完整讲一遍。今天先开第一篇：**HSMS 通讯层**。
...
*作者简介：EAP 自动化工程师，深耕 SECS/GEM 与 GEM300（E30/E37/E5/E87/E90/E94），提供定制开发与远程排障服务（晚 7 点后 + 周末）。*
